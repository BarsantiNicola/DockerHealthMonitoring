...
class client:
    ...
    def send_antagonist_unicast(self, message, hostname) -> bool:
    ...
    def send_antagonist_multicast(self, message):
    ...
    def send_manager_unicast(self, message, hostname) -> bool:
    ...
    def send_manager_multicast(self, message) -> bool:
    ...
    def send_controller(self, message) -> bool:
    ...
    def allocate_receiver(self, receiver_type, callback_fun):
